...
route.post('/add-task' ,isAuth, body('title').trim().isLength({max:255 , min:5})  , tasksControllers.createTask)
route.put('/edit-task/:id' ,isAuth, body('title').trim().isLength({max:255 , min:5})  , tasksControllers.editTask)
